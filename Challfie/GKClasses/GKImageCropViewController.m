...
- (void)_setupNavigationBar{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Valider", @"")
...
- (void)_setupCancelButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.cancelButton setFrame:CGRectMake(0, 0, 100, 30)];
...
- (void)_setupUseButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.useButton setFrame:CGRectMake(0, 0, 100, 30)];
        [self.useButton setTitle:NSLocalizedString(@"confirm",@"Confirm") forState:UIControlStateNormal];
...
- (UIImage *)_toolbarBackgroundImage{
    ...
    CGContextDrawLinearGradient(ctx, gradient, CGPointMake(0, 0), CGPointMake(0, 54), kCGGradientDrawsBeforeStartLocation); // CUSTOM FAB
...
- (void)viewWillLayoutSubviews{
    ...
    //self.imageCropView.frame = CGRectMake(0.0, 0.0, 20.0f, 200.0f);
